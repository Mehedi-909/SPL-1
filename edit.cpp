...
int main(){
    ...
    while(fgets ( getLine, sizeof getLine, fp ) != NULL ){
        ...
        for(i=0;i<length;i++){
            ...
            else if((store1[i].compare("+"))==0 || (store1[i].compare("-"))==0 || (store1[i].compare("*"))==0 || 			(store1[i].compare("/"))==0 || (store1[i].compare("%"))==0){
    ...
    while(fgets ( getLine, sizeof getLine, fp ) != NULL){
        ...
        for(i=0;i<length;i++){
            ...
            else if((store2[i].compare("("))==0 && (store2[i+2].compare(")"))==0){
         ...
         while (ss >> store3[i]){
           ...
           if((store3[i].compare(variable))==0 || (store3[i].compare(var[count3]))==0 || (store3[i].compare(var[count3+1]))==0 || (store3[i].compare(var[count3+2]))==0 || (store3[i].compare(var[count3+3]))==0 ){
                ...
                for(int j=0;j<strlen(getLine);j++){
                	...
                	for(int m=0;m< checkLine ;m++){
                		if((check.compare(check2[m]))!=0){
                			check2[checkLine]=getLine;
                			checkLine++;
                			for(int j=0;j<strlen(getLine);j++){
                    			//printf("%c",getLine[j]);
