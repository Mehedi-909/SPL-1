...
int main(){
    ...
    while(fgets ( getLine, sizeof getLine, fp )){
        ...
        for(i=0;i<length;i++){
            ...
            if((store2[i].compare("="))==0 || (store2[i].compare("!="))==0 || (store2[i].compare("<="))==0 || (store2[i].compare(">="))==0 ){
                ...
                if( (store2[i].compare(variable))==0 ){
   ...
   // cout<<"New variable stored in string: "<<var[count3]<<endl;
    ...
    while(fgets ( getLine, sizeof getLine, fp )){
        ...
        int i=0;
         while (ss >> store3[i]){
           if((store3[i].compare(variable))==0 || (store3[i].compare(var[count3]))==0 || (store3[i].compare(var[count3+1]))==0 || (store3[i].compare(var[count3+2]))==0){
